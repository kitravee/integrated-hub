...
export const AnimatedBeamDemo: FC = () => {
  ...
  return (
    <div
      className="relative flex h-[320px] w-full items-center justify-center overflow-hidden rounded-lg bg-background "
      ref={containerRef}
    >
      <div className="flex size-full flex-col max-w-lg max-h-[200px] items-stretch justify-between gap-10">
        ...
        <div className="flex flex-row items-center justify-between">
          ...
          <Circle ref={div4Ref} className="size-16">
            <FrameIcon width={100} height={100} className="text-black" />
          </Circle>
          <Circle ref={div6Ref}>
            <Icons.line />
          </Circle>
